...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.legal-documents.update', $document->id) }}" method="POST" class="mb-5">
            @csrf
            @method('PATCH')
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        <p><strong>Table Name:</strong> {{ $document->table_name }}</p>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <p><strong>Upload Date:</strong> {{ \Carbon\Carbon::parse($document->created_at)->format('F d, Y H:i:s') }}</p>
                    </div>
                </div>
            </div>
