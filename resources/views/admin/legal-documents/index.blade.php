                ...
                <div class="row" id="documentsGrid">
                    @foreach($documents as $document)
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-4 document-item" 
                            ...
                            <div class="card document-card h-100 {{ ($document->status ?? 'active') == 'inactive' ? 'inactive-document' : '' }}">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('admin.legal-documents.edit', $document->id) }}">
                                                <i class="fas fa-edit me-2"></i>Edit
                                            </a></li>
                                            <li><button class="dropdown-item toggle-status-btn" 
                                                       data-id="{{ $document->id }}"
                                                       data-status="{{ $document->status ?? 'active' }}">
                                                <i class="fas {{ ($document->status ?? 'active') == 'active' ? 'fa-pause' : 'fa-play' }} me-2"></i>
                                                {{ ($document->status ?? 'active') == 'active' ? 'Deactivate' : 'Activate' }}
                                            </button></li>
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <h5 class="card-title text-primary mb-3">{{ $document->act_name }}</h5>
                                    
                                    <div class="document-details">
                                        <div class="detail-row mb-2">
                                            <i class="fas fa-table me-2 text-muted"></i>
                                            <span class="text-muted small">Table:</span>
                                            <span class="ms-1">{{ $document->table_name }}</span>
                                        </div>
                                        ...
                                        <div class="text-muted small">
                                            ...
                                            Uploaded: {{ \Carbon\Carbon::parse($document->created_at)->format('M d, Y \a\t H:i') }}
                                        </div>
                                    </div>
                                </div>
