                            ...
                            <div class="toggle-tile-body col-12 list" data-card-index="{{ $index }}">
                                <div class="toggle-tile-content shadow-sm sp-top" 
                                    ...
                                    <ul class="act-data">
                                        ...
                                        <li class="view-button"><a href="javascript:void(0)" onclick="redirectToDocument('{{ $row->table_name }}', '{{ $row->act_id }}', '{{ $client->id }}', '{{ $row->language_id }}')"><strong>View Document</strong> <i class="fas fa-arrow-right"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            @endforeach
