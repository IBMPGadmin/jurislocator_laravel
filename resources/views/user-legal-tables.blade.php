                    ...
                    <button type="button" class="btn btn-outline-success btn-lg" id="saveToClientRecords">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-start">
                                ...
                                <small class="text-muted" data-en="Specific to {{ $client->client_name }} - only visible when this client is selected" data-fr="Spécifique à {{ $client->client_name }} - visible uniquement quand ce client est sélectionné">Specific to {{ $client->client_name }} - only visible when this client is selected</small>
                            </div>
                        </div>
                    </button>
                    @else
