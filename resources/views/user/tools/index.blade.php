...
<div class="tools-container">
    <div class="tools-content">
        ...
        <div class="tools-grid">
            ...
            <div class="tool-card" onclick="window.location.href='{{ route('user.tools.date-to-date') }}'">
            ...
            <!-- Age Calculator -->
            <div class="tool-card" onclick="window.location.href='{{ route('user.tools.age-calculator') }}'">
            ...
            <!-- Currency Converter -->
            <div class="tool-card" onclick="window.location.href='{{ route('user.tools.currency-converter') }}'">
            ...
            <div class="tool-card" onclick="window.location.href='{{ route('user.tools.add-subtract-date') }}'">
            ...
            <!-- World Clock -->
            <div class="tool-card" onclick="window.location.href='{{ route('user.tools.time-zones') }}'">
