        ...
        <div class="row">
            ...
            <div class="row gap_top custom-container act-content">
                <div class="act-content grid-view">
                    @foreach(['Client Introduction Letter', 'Case Status Update Letter', 'Application Submission Letter'] as $index => $template)
                        <div class="act-card btn-shadow template-item">
                            <div class="act-card-inner">
                                <i class="fas fa-file-word act-icon"></i>
                                <div class="act-home-title">{{ $template }}</div>
                                <div class="act-category">Template Type: Document</div>
                                <div class="act-description">Template for {{ strtolower($template) }}</div>
                                <a href="{{ route('templates.edit', ['client_id' => isset($client) ? $client->id : 1, 'template_id' => $index + 1]) }}" 
                                class="view-button">
