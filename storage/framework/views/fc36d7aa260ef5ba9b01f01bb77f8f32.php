        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($notes->total()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($notes->where('updated_at', '>=', now()->subDays(7))->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($notes->where('type', 'annotation')->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($notes->where('type', 'personal_note')->count()); ?></h3>
            ...
            <?php if($notes->count() > 0): ?>
                <div class="notes-container">
                    <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="note-card card border-0 shadow-sm mb-3" data-note-id="<?php echo e($note->id); ?>">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="note-content flex-grow-1">
                                        <div class="d-flex align-items-center mb-2">
                                            <h5 class="note-title mb-0"><?php echo e($note->title ?: 'Untitled Note'); ?></h5>
                                            <span class="badge bg-<?php echo e($note->type === 'personal_note' ? 'primary' : 'success'); ?> ms-2">
                                                <?php echo e(ucfirst(str_replace('_', ' ', $note->type))); ?>

                                            </span>
                                        </div>
                                        <div class="note-body">
                                            <?php echo Str::limit(strip_tags($note->content), 200); ?>

                                        </div>
                                        <div class="note-meta mt-2">
                                            <small class="text-muted">
                                                <i class="fas fa-clock me-1"></i>
                                                <span data-en="Updated:" data-fr="Mis à jour :">Updated:</span> <?php echo e($note->updated_at->diffForHumans()); ?>

                                                <?php if($note->document_id): ?>
                                                    <i class="fas fa-file-alt ms-3 me-1"></i>
                                                    <span data-en="From document:" data-fr="Du document :">From document:</span> <?php echo e($note->table_name); ?>
                                    ...
                                    <div class="note-actions">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#" onclick="editNote(<?php echo e($note->id); ?>)">
                                                    <i class="fas fa-edit me-2"></i><span data-en="Edit" data-fr="Modifier">Edit</span>
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="viewNote(<?php echo e($note->id); ?>)">
                                                    <i class="fas fa-eye me-2"></i><span data-en="View Full" data-fr="Voir en entier">View Full</span>
                                                </a></li>
                                                <?php if($note->document_id): ?>
                                                <li><a class="dropdown-item" href="#" onclick="goToDocument('<?php echo e($note->table_name); ?>', '<?php echo e($note->document_id); ?>')">
                                                    <i class="fas fa-external-link-alt me-2"></i><span data-en="Go to Document" data-fr="Aller au document">Go to Document</span>
                                                </a></li>
                                                <?php endif; ?>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="dropdown-item text-danger" href="#" onclick="deleteNote(<?php echo e($note->id); ?>)">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('user.legal-tables')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\user-notes.blade.php ENDPATH**/ ?>