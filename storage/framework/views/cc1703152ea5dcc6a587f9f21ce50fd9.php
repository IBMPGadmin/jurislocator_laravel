...
<head>
  ...
  <style>
    ...
    /* Ensure icon and text are left aligned */
    .pc-submenu .pc-link i {
      margin-right: 8px;
      flex-shrink: 0;
    }
    .pc-submenu .pc-link span:not(.badge) {
      flex-grow: 1;
      text-align: left;
    }
    /* Fix for pending approvals link specifically */
    .pc-submenu .pc-link .badge-container {
      display: flex;
      align-items: center;
      justify-content: space-between;
      width: 100%;
    }
    .pc-submenu .pc-link .text-content {
      display: flex;
      align-items: center;
      flex-grow: 1;
    }
      ...
      <ul class="pc-navbar">        
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item">
              <a class="pc-link" href="/admin/users/add">
                <div class="text-content">
            ...
            <li class="pc-item">
              <a class="pc-link" href="/admin/users">
                <div class="text-content">
...
<?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel_new\resources\views/layouts/admin.blade.php ENDPATH**/ ?>