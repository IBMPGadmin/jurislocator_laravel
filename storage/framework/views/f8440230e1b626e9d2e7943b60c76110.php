...
document.getElementById('ageCalculatorForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("tools.calculate-age")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views/user/tools/age-calculator.blade.php ENDPATH**/ ?>