...
<div class="container">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e(count($programs)); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e(collect($programs)->where('category', 'Economic Immigration')->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e(collect($programs)->where('category', 'Family Immigration')->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e(collect($programs)->where('category', 'Provincial Immigration')->count()); ?></h3>
    ...
    <div class="row programs-container">
        <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-6 mb-4 program-item" data-category="<?php echo e($program['category']); ?>" data-processing-time="<?php echo e($program['processing_time']); ?>">
                <div class="card border-0 shadow-sm h-100 program-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="program-icon">
                                ...
                                ?>
                                <i class="<?php echo e($iconClass); ?> text-primary" style="font-size: 2.5rem;"></i>
                            </div>
                            <span class="badge bg-primary"><?php echo e($program['category']); ?></span>
                        </div>
                        
                        <h4 class="program-title mb-3" data-en="<?php echo e($program['name']); ?>" data-fr="<?php echo e($program['name']); ?>"><?php echo e($program['name']); ?></h4>
                        
                        <p class="program-description text-muted mb-3" data-en="<?php echo e($program['description']); ?>" data-fr="<?php echo e($program['description']); ?>">
                        ...
                        <div class="program-details">
                            <div class="detail-item mb-2">
                                ...
                                <span data-en="<?php echo e($program['processing_time']); ?>" data-fr="<?php echo e($program['processing_time']); ?>"><?php echo e($program['processing_time']); ?></span>
                            </div>
                            
                            <div class="detail-item mb-2">
                                <i class="fas fa-list text-success me-2"></i>
                                <strong data-en="Requirements:" data-fr="Exigences :">Requirements:</strong>
                                <a href="#" class="text-decoration-none" onclick="showRequirements(<?php echo e($index); ?>)">
                    ...
                    <div class="card-footer bg-light border-0">
                        <div class="d-flex justify-content-between">
                            <button class="btn btn-outline-primary btn-sm" onclick="learnMore(<?php echo e($index); ?>)">
                                <i class="fas fa-book-open me-1"></i>
                                <span data-en="Learn More" data-fr="En savoir plus">Learn More</span>
                            </button>
                            <button class="btn btn-primary btn-sm" onclick="startApplication(<?php echo e($index); ?>)">
...
<script>
const programsData = <?php echo json_encode($programs, 15, 512) ?>;
...
function openResource(resourceType) {
    const resources = {
        ...
        'contact-support': '<?php echo e(route("user.support")); ?>'
    };
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\user-immigration-programs.blade.php ENDPATH**/ ?>