...
<div class="container-fluid px-4">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-layer-group me-2"></i>Documents Library
            </h6>
        </div>
        <div class="card-body">
            <?php if(count($documents) > 0): ?>
                <div class="row" id="documentsGrid">
                    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-4 document-item" 
                            ...
                            <div class="card document-card h-100 <?php echo e(($document->status ?? 'active') == 'inactive' ? 'inactive-document' : ''); ?>">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo e(route('admin.legal-documents.edit', $document->id)); ?>">
                                                <i class="fas fa-edit me-2"></i>Edit
                                            </a></li>
                                            <li><button class="dropdown-item toggle-status-btn" 
                                                       data-id="<?php echo e($document->id); ?>"
                                                       data-status="<?php echo e($document->status ?? 'active'); ?>">
                                                <i class="fas <?php echo e(($document->status ?? 'active') == 'active' ? 'fa-pause' : 'fa-play'); ?> me-2"></i>
                                                <?php echo e(($document->status ?? 'active') == 'active' ? 'Deactivate' : 'Activate'); ?>

                                            </button></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><button class="dropdown-item text-danger delete-doc-btn"
                                                       data-id="<?php echo e($document->id); ?>"
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <h5 class="card-title text-primary mb-3"><?php echo e($document->act_name); ?></h5>
                                    
                                    <div class="document-details">
                                        <div class="detail-row mb-2">
                                            <i class="fas fa-table me-2 text-muted"></i>
                                            <span class="text-muted small">Table:</span>
                                            <span class="ms-1"><?php echo e($document->table_name); ?></span>
                                        </div>
                                        
                                        <div class="detail-row mb-2">
                                            <i class="fas fa-balance-scale me-2 text-muted"></i>
                                            <span class="text-muted small">Law Subject:</span>
                                        ...
                                        <div class="detail-row mb-2">
                                            ...
                                            <span class="text-muted small">Act Category:</span>
                                        ...
                                        <div class="detail-row mb-2">
                                            ...
                                            <span class="text-muted small">Jurisdiction:</span>
                                        ...
                                        <div class="text-muted small">
                                            ...
                                            Uploaded: <?php echo e(\Carbon\Carbon::parse($document->created_at)->format('M d, Y \a\t H:i')); ?>
                                ...
                                <div class="card-footer bg-transparent">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted">ID: <?php echo e($document->id); ?></small>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\admin\legal-documents\index.blade.php ENDPATH**/ ?>