...
<div class="client-management-container">
    ...
    <div class="add-client-section">
        <div class="section-card">
            ...
            <form method="POST" action="<?php echo e(route('clients.store')); ?>" class="client-form">
                <?php echo csrf_field(); ?>
            ...
            <div class="clients-grid">
                ...
                <?php if($clients->count() > 0): ?>
                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="client-card" onclick="selectClient(<?php echo e($client->id); ?>)">
                            <div class="client-avatar">
                                <i class="fas fa-user"></i>
                            </div>
                            <div class="client-info">
                                <h3><?php echo e($client->client_name); ?></h3>
                                <p class="client-email"><?php echo e($client->client_email); ?></p>
                                <p class="client-status status-<?php echo e(strtolower($client->client_status)); ?>">
                                    <?php echo e($client->client_status); ?>

                                </p>
                                <?php if($client->last_accessed): ?>
                                    <p class="last-accessed">
                                        <span data-en="Last accessed:" data-fr="Dernier accès:">Last accessed:</span>
                                        @try
                                            <?php echo e(is_string($client->last_accessed) ? \Carbon\Carbon::parse($client->last_accessed)->diffForHumans() : $client->last_accessed->diffForHumans()); ?>

                                        @catch(\Exception $e)
                                            <?php echo e($client->last_accessed); ?>
...
<form id="selectClientForm" method="POST" action="<?php echo e(route('clients.select')); ?>" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ardent\Desktop\jurislocator_laravel\resources\views/client-management.blade.php ENDPATH**/ ?>