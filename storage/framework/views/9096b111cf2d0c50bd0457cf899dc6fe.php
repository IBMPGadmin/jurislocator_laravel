                ...
                <div class="session-info bg-light p-3 rounded d-inline-block">
                    ...
                    <span class="ms-3 text-muted">
                        <small>
                            ...
                            <a href="<?php echo e(route('user.dashboard')); ?>" class="text-decoration-none ms-1" data-en="Switch to Client Mode" data-fr="Passer au mode client">Switch to Client Mode</a>
                        </small>
                    </span>
                </div>
            </div>
...
function navigateToLegalTables() {
    window.location.href = '<?php echo e(route("user.legal-tables")); ?>';
}

function navigateToCaseLaw() {
    // This will be filtered to show only CaseLaw category
    window.location.href = '<?php echo e(route("user.legal-tables")); ?>?act_id=3';
}

function navigateToNotes() {
    window.location.href = '<?php echo e(route("user.notes")); ?>';
}

function navigateToPrograms() {
    window.location.href = '<?php echo e(route("user.immigration-programs")); ?>';
}

function navigateToResources() {
    window.location.href = '<?php echo e(route("user.government-links")); ?>';
}

function navigateToSupport() {
    window.location.href = '<?php echo e(route("user.support")); ?>';
}
...
function navigateToTemplates() {
    window.location.href = '<?php echo e(route("user.templates")); ?>';
}

function navigateToKeyTerms() {
    window.location.href = '<?php echo e(route("user.legal-key-terms.index")); ?>';
}

function navigateToDeadlines() {
    window.location.href = '<?php echo e(route("user.rcic-deadlines.index")); ?>';
}

function switchToClientMode() {
    if (confirm('<?php echo e(__("Switch to client-based session? This will redirect you to client selection.")); ?>')) {
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\New folder (6)\jurislocator_laravel\resources\views/user-home.blade.php ENDPATH**/ ?>