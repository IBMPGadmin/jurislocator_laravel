        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($templates->total()); ?></h3>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($templates->groupBy('category')->count()); ?></h3>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1"><?php echo e($templates->where('updated_at', '>=', now()->subDays(7))->count()); ?></h3>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select class="form-select" id="filterCategory">
                                ...
                                <?php $__currentLoopData = $templates->unique('category'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($template->category); ?>"><?php echo e($template->category); ?></option>
            ...
            <?php if($templates->count() > 0): ?>
                <div class="row templates-container">
                    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 mb-4 template-item" data-template-id="<?php echo e($template->id); ?>" data-category="<?php echo e($template->category); ?>">
                            <div class="card border-0 shadow-sm h-100 template-card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#" onclick="editTemplate(<?php echo e($template->id); ?>)">
                                                    <i class="fas fa-edit me-2"></i><span data-en="Edit" data-fr="Modifier">Edit</span>
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="duplicateTemplate(<?php echo e($template->id); ?>)">
                                                    <i class="fas fa-copy me-2"></i><span data-en="Duplicate" data-fr="Dupliquer">Duplicate</span>
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="exportTemplate(<?php echo e($template->id); ?>)">
                                                    <i class="fas fa-download me-2"></i><span data-en="Export" data-fr="Exporter">Export</span>
                                                </a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="dropdown-item text-danger" href="#" onclick="deleteTemplate(<?php echo e($template->id); ?>)">
                                    ...
                                    <h5 class="template-title mb-2"><?php echo e($template->title); ?></h5>
                                    <span class="badge bg-primary mb-3"><?php echo e($template->category); ?></span>
                                    
                                    <div class="template-preview mb-3">
                                        <p class="text-muted small">
                                            <?php echo Str::limit(strip_tags($template->content), 120); ?>
                                    ...
                                    <div class="template-meta">
                                        <small class="text-muted d-block mb-2">
                                            ...
                                            <span data-en="Updated:" data-fr="Mis à jour :">Updated:</span> <?php echo e($template->updated_at->diffForHumans()); ?>
                                ...
                                <div class="card-footer bg-light border-0">
                                    <div class="d-flex justify-content-between">
                                        <button class="btn btn-outline-primary btn-sm" onclick="previewTemplate(<?php echo e($template->id); ?>)">
                                            <i class="fas fa-eye me-1"></i>
                                            <span data-en="Preview" data-fr="Aperçu">Preview</span>
                                        </button>
                                        <button class="btn btn-primary btn-sm" onclick="useTemplate(<?php echo e($template->id); ?>)">
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\user-templates.blade.php ENDPATH**/ ?>