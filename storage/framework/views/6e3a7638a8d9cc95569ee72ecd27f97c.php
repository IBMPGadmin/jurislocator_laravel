        ...
        <div class="card-header bg-warning text-white d-flex justify-content-between align-items-center py-2">
            ...
            <div class="header-controls">
                ...
                <button id="fetch-pinned-popups" class="btn btn-sm btn-outline-light me-1" 
                    data-client-id="<?php echo e($client->id ?? 0); ?>" title="Fetch Popups">
...
<?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel_new\resources\views/layouts/right-sidebar.blade.php ENDPATH**/ ?>