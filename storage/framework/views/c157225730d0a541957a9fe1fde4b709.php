    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.legal-key-terms.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="term" class="form-label">Term <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?php $__errorArgs = ['term'];
...
unset($__errorArgs, $__bag); ?>" id="term" name="term" value="<?php echo e(old('term')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="definition" name="definition" rows="4" required><?php echo e(old('definition')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="language" name="language" required>
                                ...
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($code); ?>" <?php echo e(old('language') == $code ? 'selected' : ''); ?>><?php echo e($name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['source'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="source" name="source" value="<?php echo e(old('source')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <a href="<?php echo e(route('admin.legal-key-terms.index')); ?>" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\legal-key-terms\create.blade.php ENDPATH**/ ?>