...
<body id="body-pd" class="gap_right_home">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div class="nav_list"> 
                <a href="<?php echo e(route('user.home')); ?>" class="nav_link <?php echo e(request()->routeIs('user.home') ? 'active' : ''); ?>"> 
                ...
                <a href="<?php echo e(route('user.legal-tables')); ?>" class="nav_link <?php echo e(request()->routeIs('user.legal-tables') ? 'active' : ''); ?>"> 
                ...
                <a href="<?php echo e(route('user.notes')); ?>" class="nav_link <?php echo e(request()->routeIs('user.notes') ? 'active' : ''); ?>"> 
                ...
                <a href="<?php echo e(route('user.templates')); ?>" class="nav_link <?php echo e(request()->routeIs('user.templates') ? 'active' : ''); ?>"> 
                ...
                <a href="<?php echo e(route('user.dashboard')); ?>" class="nav_link nav_workflow_switch"> 
...
<?php /**PATH C:\Users\User\Desktop\New folder (6)\jurislocator_laravel\resources\views/layouts/user-layout.blade.php ENDPATH**/ ?>