                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-success" 
                                                    ...
                                                    onclick="setApproveUser(<?php echo e($user->id); ?>, '<?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>', '<?php echo e($user->profile_picture ? Storage::url($user->profile_picture) : ''); ?>', '<?php echo e($user->student_id_file ? Storage::url($user->student_id_file) : ''); ?>')">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" 
                                                    ...
                                                    onclick="setRejectUser(<?php echo e($user->id); ?>, '<?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>', '<?php echo e($user->profile_picture ? Storage::url($user->profile_picture) : ''); ?>', '<?php echo e($user->student_id_file ? Storage::url($user->student_id_file) : ''); ?>')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\13\jurislocator_laravel\resources\views/admin/user-approvals/index.blade.php ENDPATH**/ ?>