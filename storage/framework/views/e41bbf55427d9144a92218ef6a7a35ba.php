                    ...
                    <div class="row mt-4">                        <div class="col-md-4 mb-4">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('templates.select-client')); ?>" class="btn btn-outline-primary">View Templates</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\home.blade.php ENDPATH**/ ?>