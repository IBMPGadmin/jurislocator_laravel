            ...
            <div class="bg_custom p-4 rounded shadow-sm">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <div class="user-avatar me-4 d-flex justify-content-center align-items-center rounded-circle bg-light text-success" style="width: 60px; height: 60px; font-size: 24px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                            <i class="fas fa-user"></i>
                        </div>
                        <div class="user-info flex-grow-1">
                            <h4 class="mb-2" data-en="Personal Workspace" data-fr="Espace de travail personnel">Personal Workspace</h4>
                            <div class="d-flex flex-wrap">
                                <div class="me-4 mb-2">
                                    <span class="d-flex align-items-center">
                                        <strong data-en="User:" data-fr="Utilisateur :">User:</strong>&nbsp;<?php echo e(auth()->user()->name ?? '-'); ?>
                                ...
                                <div class="mb-2">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <strong data-en="Email:" data-fr="Courriel :">Email:</strong>&nbsp;<?php echo e(auth()->user()->email ?? '-'); ?>
                    ...
                    <div class="workflow-info">
                        <span class="badge bg-success px-3 py-2">
                            ...
                            <span data-en="Personal Research Mode" data-fr="Mode de recherche personnelle">Personal Research Mode</span>
                        </span>
                        <div class="mt-2">
                            <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-sm btn-outline-secondary">
                                <i class="fas fa-home me-1"></i>
                                <span data-en="Back to Home" data-fr="Retour à l'accueil">Back to Home</span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="row gap_top custom-container act-content">
            <div class="act-content grid-view">
                <?php if($results->count()): ?>
                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <div class="col-lg-4 col-md-6 act-card btn-shadow" onclick="redirectToUserDocument('<?php echo e($row->table_name); ?>', '<?php echo e($row->id); ?>', '<?php echo e($row->language_id ?? $row->language ?? ''); ?>')">
            ...
            <div class="act-content list-view" style="display: none;">
                <?php if($results->count()): ?>
                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <div class="col-lg-12 act-card btn-shadow" onclick="redirectToUserDocument('<?php echo e($row->table_name); ?>', '<?php echo e($row->id); ?>', '<?php echo e($row->language_id ?? $row->language ?? ''); ?>')">
                            <div class="act-card-inner">
                                <div class="act-home-title"><?php echo e($row->act_name); ?></div>
                                <div class="act-language" style="color: red;"><span data-en="Language:" data-fr="Langue :">Language:</span> 
                                    <?php
...
<script>
    // Function to redirect to appropriate document view based on language (User-centric)
    function redirectToUserDocument(tableName, categoryId, language) {
        ...
        // Debug logging
        console.log('Redirecting to user document:', {
            tableName: tableName,
        ...
        if (isFrench) {
            // Redirect to French view (user-centric with user_id)
            const url = `/user/${userId}/view-legal-table-french/${tableName}?category_id=${categoryId}`;
            console.log('French URL:', url);
            window.location = url;
        } else {
            // Redirect to normal view (user-centric with user_id)
            const url = `/user/${userId}/view-legal-table/${tableName}?category_id=${categoryId}`;
    ...
    function translateUserLegalTablesPage(language) {
    ...
    window.addEventListener('languageChanged', function(event) {
        ...
        translateUserLegalTablesPage(selectedLanguage);
    });

    // Apply saved language on page load
    document.addEventListener('DOMContentLoaded', function() {
        const savedLanguage = localStorage.getItem('selectedLanguage') || 'en';
        translateUserLegalTablesPage(savedLanguage);
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dileesha\Desktop\jurislocator_laravel\resources\views\user-legal-tables-personal.blade.php ENDPATH**/ ?>